  ...
  return (
    <>
      <div className="lg:flex">
          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div className="mt-12">
              ...
              <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                ...
                <a className="cursor-pointer text-black opacity-50 hover:opacity-100">
                  Sign up
                </a>
              </div>
            </div>
        ...
        <div className="hidden lg:flex items-center justify-center bg-main-black flex-1 h-screen">
